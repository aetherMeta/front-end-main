  ...
  return (
    <Flex flexDirection="column">
      <Flex justifyContent="space-between">
        <Flex flexDirection="column" mb="5rem" ml="4rem">
          <Text variant="h2">JOIN AETHER META</Text>
          <Text variant="h2Bold">IN FOUR EASY STEPS</Text>
        </Flex>
        <Image src="/images/admin.svg" width={460} height={460} />
      </Flex>
      <Flex alignItems="center" flexDirection="column">
        ...
        <Image src="/images/heels.svg" height={600} width={600} />
      </Flex>
    </Flex>
  );
};
