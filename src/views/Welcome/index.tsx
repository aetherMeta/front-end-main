        ...
        <Flex justifyContent="space-between">
          ...
          <TextContainer style={{ marginLeft: "130px" }}>
            ...
            <Text variant="body">
              ...
              as well, growing stronger as we built and interacted with it. We
              named this land AetherMeta and we plan on restoring it to its
              ...
              guests will receive exclusive invitations as well. Join us in this
              place of wonder and secrets. Here you will find the most exclusive
              marketplace in the metaverse with a stunning collection of luxury
              brands, art – and more. Enter our metaverse and allow yourself to
              absorb the warmth of the sun, window-shop the picturesque streets
              and get lost wandering the mountains and gardens. And of course,
              there’s the breathtakingly endless clouds and sky. With your help
              and our team’s capabilities, we can together restore AetherMeta to
              an everlasting ecosystem of luxury and creativity. All are welcome
              – you just have to find a way up here.
            </Text>
          </TextContainer>
        </Flex>
